...
<template>
  <DarDialog :isOpen="props.is_open" :contentClass="'bg-white p-4'" :width="'860'">
 ...
 -->
      ...
      <section class="p-2">
        ...
        <div class="rounded-lg mt-2 p-4 border bg-gray-50">
          <div class="grid grid-cols-6 gap-6">
            ...
            <div class="col-span-6">
              <p class="block text-sm font-medium text-gray-700">Previous Copy Title</p>
              <div class="grid grid-cols-6 gap-6 mt-2">
                <div class="col-span-3 rounded-lg">
                  <label
                    for="street-address"
    ...
    <template #actions>
      <section class="flex justify-end mr-4">
        ...
        <DarButton v-if="props.is_updating === false" @click="showDialog = false">
          Save</DarButton
        >
