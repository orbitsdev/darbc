  ...
  <w-app>
    ...
    <div class="min-h-full grid grid-cols-12 ">
      <div class="col-span-2">
        <nav
          class="darnav dr-bg-purple-active py-4 flex flex-1 flex-col divide-y divide-cyan-800 overflow-y-auto"
          aria-label="Sidebar"
        >
      
          <div  class="space-y-1 px-2">
            <DarLink :active="$page.component === 'dashboard'" href="/dashboard" >
              <svg
            ...
            <DarLink :active="$page.component === 'masterlist'" href="/masterlist">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
            ...
            <DarLink :active="$page.component === 'reports'" href="/reports">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
      ...
      <div class="col-span-10 bg-gray-200 pb-2">
